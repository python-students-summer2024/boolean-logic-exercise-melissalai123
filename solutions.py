...
def is_sweltering():
    ...
    temp = input("What's the current temperature in Farenheit: ") 
    temp = float(temp)
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    response = input("Is it humid today? (yes or no): ")
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    response = input("What's the weather forecast for today? ").lower()
    if "rain" in response or "snow" in response or "sleet" in response:
        return True
    else:
        return False
